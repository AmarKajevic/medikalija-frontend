...
export const useCombinations = (patientId: string) => {
  ...
  const getAnalyses = useQuery<Analysis[]>({
    queryKey: ["analyses"],
    queryFn: async () => {
      const { data } = await axios.get("https://medikalija-frontend.vercel.app/api/analysis", {
  ...
  const combinationsQuery = useQuery<Combination[]>({
    ...
    queryFn: async () => {
      const { data } = await axios.get(
        "https://medikalija-frontend.vercel.app/api/analysis/combination",
        { headers: { Authorization: `Bearer ${token}` } }
      );
  ...
  queryFn: async () => {
    const { data } = await axios.get(
      `https://medikalija-frontend.vercel.app/api/analysis/combination/combinations/${patientId}`,
      { headers: { Authorization: `Bearer ${token}` } }
    );
    return data.success ? data.combinations : [];
  },
...
const getGroupsWithCombinations = useQuery<Group[]>({
  queryKey: ["groups"],
  queryFn: async () => {
    const {data} = await axios.get("https://medikalija-frontend.vercel.app/api/combinationGroup",{
      headers:
  ...
  //     const {data} = await axios.get(`https://medikalija-frontend.vercel.app/api/analysis/combination/combinations/${patientId}`,{
  //       headers: {
  //         Authorization: `Bearer ${token}`,
  //       }
  //     })
  ...
  const addCombination = useMutation({
    mutationFn: async (payload: {
      ...
      const { data } = await axios.post(
        "https://medikalija-frontend.vercel.app/api/analysis/combination/addCombination",
        payload,
        { headers: { Authorization: `Bearer ${token}` } }
      );
      return data;
  ...
  const addCombinationToPatient = useMutation({
    mutationFn: async(combination: {
      ...
      const {data} = await axios.post(`https://medikalija-frontend.vercel.app/api/analysis/combination/addToPatient/${patientId}`,{ combinationId},{
        headers: {
          Authorization: `Bearer ${token}`
        }
      })
  ...
  const addCombinationToGroup = useMutation({
    mutationFn: async (group: {name: string, combinations: string[]}) => {
      const {data} = await axios.post(`https://medikalija-frontend.vercel.app/api/combinationGroup`, {...group}, {
        headers: {
          Authorization: `Bearer ${token}`
        }
      })
