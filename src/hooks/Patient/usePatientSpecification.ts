    ...
    queryFn: async () => {
      try {
        const { data } = await axios.get(
          `https://medikalija-frontend.vercel.app/api/specification/${patientId}`,
   ...
   return useQuery({
    ...
    queryFn: async () => {
      const response = await axios.get(
        `https://medikalija-frontend.vercel.app/api/specification/history/${patientId}`,
        { headers: { Authorization: `Bearer ${token}` } }
      );
...
export const useSingleSpecification = (specificationId: string) => {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      const { data } = await axios.get(
        `https://medikalija-frontend.vercel.app/api/specification/view/${specificationId}`,
        { headers: { Authorization: `Bearer ${token}` } }
      );
