...
export default function UserDropdown() {
  ...
  const handleLogout = async () => {
    closeDropdown();
    await logout();        // poziv backend /logout + čišćenje state-a
    navigate("/signin");   // redirekcija
  };
  return (
    <div className="relative">
      ...
      >
        ...
        <span className="block mr-1 font-medium text-theme-sm">{user ? user.name : "Guest"}</span>
        <svg
