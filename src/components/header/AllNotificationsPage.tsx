...
export default function AllNotificationsPage() {
  ...
  const fetchNotifications = async () => {
    try {
      const res = await axios.get("https://medikalija-frontend.vercel.app/api/notifications", {
  ...
  const markAllAsRead = async () => {
    try {
      await axios.put(
        "https://medikalija-frontend.vercel.app/api/notifications/read-all",
        {},
        {
          headers: { Authorization: `Bearer ${token}` },
        }
  ...
  const markOneAsRead = async (id: string) => {
    try {
      await axios.put(
        `https://medikalija-frontend.vercel.app/api/notifications/${id}/read`,
        {},
        {
          headers: { Authorization: `Bearer ${token}` },
        }
